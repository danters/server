...
row = HCommon.execProcOneRow("call UpdateCityCheckinHandoff(%s,%s,%s)", (str(bookingId),str(HBook.BOOK_STATE_BOOK_ASSIGNED),"0"))

booking['state'] = HBook.BOOK_STATE_BOOK_ASSIGNED
